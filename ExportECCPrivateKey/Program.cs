    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                PbeParameters pbeParameters = new PbeParameters(PbeEncryptionAlgorithm.Aes256Cbc,HashAlgorithmName.SHA256, 1000000);
                byte[] myPrivateKeyBytes = myPrivateKey.ExportEncryptedPkcs8PrivateKey(passwordBytes,pbeParameters);
